...
Metropolis-Hasting shows good accurary. For mean of A, the result of MH is closed to the result of linear model. The standard deviance in MH and in linear model are also closed, which indicates that the accurary of MH in estimating A is similar to the linear model.
